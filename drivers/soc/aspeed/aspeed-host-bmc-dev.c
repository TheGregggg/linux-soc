...
static const unsigned int vuart_msi_index[2] = { 16, 17 };
static const u16 vuart_port_addr[2] = { 0x3f8, 0x2f8 };
...
static int aspeed_pci_bmc_device_setup_vuart(struct pci_dev *pdev, int idx)
{
	...
	vuart_ioport = vuart_port_addr[idx] << 2;
...
static struct pci_device_id aspeed_host_bmc_dev_pci_ids[] = {
	{ PCI_DEVICE(PCI_VENDOR_ID_ASPEED, PCI_BMC_DEVICE_ID), .class = PCI_CLASS_OTHERS << 16, .class_mask = 0xFFFF00 },
	{ 0 }
};
